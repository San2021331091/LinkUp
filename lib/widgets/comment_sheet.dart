...
class _CommentSheetState extends State<CommentSheet> {
  ...
  /// Get user from CommentController cache or fallback
  User getUser(String userId) {
    return commentController.userCache[userId] ?? User(uid: userId, name: "Unknown");
  }
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    IconButton(
                                                      ...
                                                      onPressed: () async {
                                                        await commentController.deleteComment(commentId: comment.id!);
                                                      },
                                                    ),
                                                  ],
                                                ),
