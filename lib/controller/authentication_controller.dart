...
class AuthenticationController extends GetxController {
 ...
 Future<void> checkUserLoggedIn() async {
  ...
  if (user != null) {
    // Check if this user's UID exists in the 'users' table
    ...
    if (existingUser != null) {
      // User exists in table, go to HomeScreen
      Get.offAll(() => const HomeScreen());
    } else {
      // UID not found in users table, force login again
    ...
    // No auth user, go to LoginScreen
    Get.offAll(() => const LoginScreen());
  }
}
